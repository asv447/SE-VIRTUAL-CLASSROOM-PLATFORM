...
export default function QAInterface() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setHistory((prev) => [
        { id: Date.now(), topic, question, answer: data.answer, timestamp: new Date().toLocaleString() },
        ...prev,
      ]);
    } catch (err) {
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 shadow-xl">
              <div className="space-y-4">
                ...
                {error && (
                  <div className="bg-red-900/30 border border-red-500/50 text-red-300 px-4 py-3 rounded-lg">{error}</div>
                )}
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={handleClear} className="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-gray-200 rounded-lg transition-colors">
                    Clear
                  </button>
                </div>
              </div>
            ...
            {answer && (
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 shadow-xl">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={handleCopy} className="flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors text-sm">
                    {copied ? (
                      <>
                ...
                <div className="prose prose-invert prose-purple max-w-none">
                  <div className="whitespace-pre-wrap text-gray-300 leading-relaxed">{answer}</div>
                </div>
              </div>
            )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/30 shadow-xl">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-1">•</span><span>Enter a topic you want to learn about</span></li>
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-1">•</span><span>Ask your specific question</span></li>
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-1">•</span><span>Get detailed answers powered by AI</span></li>
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-1">•</span><span>Use Ctrl+Enter to submit quickly</span></li>
              </ul>
            </div>
          </div>
        </div>
