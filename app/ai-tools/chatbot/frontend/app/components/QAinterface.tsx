...
export default function QAInterface() {
  ...
  const clearHistory = () => {
    ...
    toast({
      ...
      description: "All saved Q&A sessions have been removed.",
    });
  ...
  return (
    <>
      <div className="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black text-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      disabled={loading}
                      className="flex-1 bg-linear-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-purple-500/30"
                    >
                      {loading ? (
                        <>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-linear-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/30 shadow-xl">
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This removes all saved conversations from this page.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
